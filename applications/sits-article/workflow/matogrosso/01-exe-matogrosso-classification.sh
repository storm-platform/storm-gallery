...
docker exec \
    ...
    -w /home/jovyan/sits-article pkg-sits-article \
      workbench exec run --name "Experiment - Mato Grosso LULC classification" make startclassification-matogrosso
...
docker exec \
    -w /home/jovyan/sits-article pkg-sits-article \
      workbench export compendium -o data/derived_data/execution-compendium/matogrosso
