...
docker exec \
    ...
    -w /home/jovyan/bdc-article pkg-bdc-article \
      workbench exec run --name "Experiment - Extract Time Series from Data Cubes (1)" make exe-timeseries
...
docker exec \
    -w /home/jovyan/bdc-article pkg-bdc-article \
      workbench export compendium -o data/derived_data/execution-compendium/timeseries
